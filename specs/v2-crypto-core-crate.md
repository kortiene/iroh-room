...
- [x] Independent audit of governance state machine and fork handling is complete and recorded (`docs/audits/v2-governance-fork-audit-2026-07-30.md` — APPROVED 2026-07-30 by non-author reviewer; 14 safety invariants verified code+test; finding L1 fixed pre-sign-off at `machine.rs:506`; §13.4 gate satisfied).
